...
app.use(["/", "/api"], baiguullagaRoute);
app.use(["/", "/api"], ajiltanRoute);
app.use(["/", "/api"], licenseRoute);
app.use(["/", "/api"], orshinSuugchRoute);
app.use(["/wallet", "/api/wallet"], walletRoute);
app.use(["/", "/api"], gereeRoute);
app.use(["/", "/api"], gereeniiZagvarRoute);
app.use(["/", "/api"], nekhemjlekhiinZagvarRoute);
app.use(["/", "/api"], bankniiGuilgeeRoute);
app.use(["/", "/api"], dansRoute);
app.use(["/", "/api"], ebarimtRoute);
app.use(["/nekhemjlekhCron", "/api/nekhemjlekhCron"], nekhemjlekhCronRoute);
app.use(["/", "/api"], medegdelRoute);
...
app.use(["/", "/api"], nekhemjlekhRoute);
app.use(["/", "/api"], qpayRoute);
app.use(["/", "/api"], tailanRoute);
app.use(["/", "/api"], pdfRoute);
app.use(["/", "/api"], mailRoute);
app.use(["/", "/api"], ashiglaltiinZardluudRoute);
app.use(["/", "/api"], zogsoolRoute);
